...
public class MainActivity extends Activity {
    ...
    private com.tarmac.yolov2Tiny.yolov2Tiny yolov2Tiny = new yolov2Tiny();
    ...
    private void initYolov2Tiny() throws IOException {
       ...
       // byte[] bin = null;
//        {
//            InputStream assetsInputStream = getAssets().open("yolov3-tiny.param");
...
//        }
        ...
        load_result = yolov2Tiny.Init(paramPath, binPath);
    ...
    private void readCacheLabelFromLocalFile() {
        try {
            ...
            BufferedReader reader = new BufferedReader(new InputStreamReader(assetManager.open("words.names")));
    ...
    private void predict_image(String image_path) {
        ...
        try {
            ...
            // get predict result
            float[] result = yolov2Tiny.Detect(rgba);
            if ( result.length==0 ) {
